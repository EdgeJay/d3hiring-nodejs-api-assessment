...
/**
 * Returns config object needed to setup database client.
 *
 * @param param0 Object that should contain
 * DB_CLIENT, DB_HOST, DB_USER, DB_PASS and DB_NAME fields needed
 * to setup database client.
 */
